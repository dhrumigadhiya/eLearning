...
def about(request):
    return render(request,'frmabout.html')

def service(request):
    return render(request,'frmService.html')
# ===================================================== Functions For User ===============================================================
...
def AddStuCourse(request,mobileno):
    ...
    courses =   tblcourse.objects.all()  
    return render(request,'User/frmAddStuCourse.html',{'mobno' : valmobileno,'courses': courses})
